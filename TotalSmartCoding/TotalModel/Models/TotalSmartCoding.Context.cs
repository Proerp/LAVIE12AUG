...
namespace TotalModel.Models
{
    ...
    public partial class TotalSmartCodingEntities : DbContext
    {
        ...
        public virtual DbSet<Lavie> Lavies1 { get; set; }
        ...
        public virtual ObjectResult<LavieIndex> GetLavieIndexes(Nullable<int> userID, Nullable<System.DateTime> fromDate, Nullable<System.DateTime> toDate)
        {
            var userIDParameter = userID.HasValue ?
                new ObjectParameter("UserID", userID) :
                new ObjectParameter("UserID", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<LavieIndex>("GetLavieIndexes", userIDParameter, fromDateParameter, toDateParameter);
        }
    
        public virtual ObjectResult<string> LavieEditable(Nullable<int> entityID)
        {
            var entityIDParameter = entityID.HasValue ?
                new ObjectParameter("EntityID", entityID) :
                new ObjectParameter("EntityID", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<string>("LavieEditable", entityIDParameter);
        }
    
        public virtual int LavieSaveRelative(Nullable<int> entityID, Nullable<int> saveRelativeOption)
        {
            var entityIDParameter = entityID.HasValue ?
                new ObjectParameter("EntityID", entityID) :
                new ObjectParameter("EntityID", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("LavieSaveRelative", entityIDParameter, saveRelativeOptionParameter);
        }
    
        public virtual int LavieDoEmpty()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("LavieDoEmpty");
        }
    
        public virtual int LavieUpdate(Nullable<int> lavieID, Nullable<int> printedReset)
        {
            var lavieIDParameter = lavieID.HasValue ?
                new ObjectParameter("LavieID", lavieID) :
                new ObjectParameter("LavieID", typeof(int));
    
            var printedResetParameter = printedReset.HasValue ?
                new ObjectParameter("PrintedReset", printedReset) :
                new ObjectParameter("PrintedReset", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("LavieUpdate", lavieIDParameter, printedResetParameter);
        }
    }
}
