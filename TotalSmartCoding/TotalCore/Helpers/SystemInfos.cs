...
namespace TotalCore.Helpers
{
    public static class SystemInfos
    {
        public static bool Validate()
        {
            ...
            string systemInfoDecrypt = SecureEncoding.Decrypt("fzs4+xEMFQA7okWRdpuqxNA0zEU5+q1YFathQCz4LOMYThGgvAsomvKtIM1UpsdyLCgR0qHloI0024vWHe7zMNFJjWQkL4eq0iZEb00+U0revKQ1SFOebnCgw/CvGbZQt5vDaF5CVyT/4PiOwWmfa/Kp5SnDXeZOJAdKtiMfMaRcJpfBigrepfLRS6nzeKds"); //VCP
